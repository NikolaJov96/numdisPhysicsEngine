...
private:
    ...
    ndGE::GLSLProgram _textureProgram; //!< ndGE object that includes shader program into project
    // input manager            //!< ndGE input manager object
    ndGE::Camera2D _camera;     //!< ndGE object that controls which part of world will be shown on screen
